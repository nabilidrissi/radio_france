...
import static com.nabilRadioFrance.radio.App.CHANNEL_ID;
import static com.nabilRadioFrance.radio.MainActivity.url;
...
public class MyService extends Service implements AudioManager.OnAudioFocusChangeListener {
    ...
    private void initPlayer() {
        ...
        mediaSource = new ProgressiveMediaSource.Factory(defaultDataSourceFactory).createMediaSource(Uri.parse(url));
        lockWiFi();
        lockCPU();
    }
